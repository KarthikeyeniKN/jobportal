...
body {
	...
	padding-left: 50rem; background-image : url("image/j2.png");
			...
			<div class="col-md-12 mx-auto">
				<div id="first">
					<div class="myform form ">
						...
						<form action="Login" method="post" name="" id="form">
							...
							<div class="form-group row">
							 ...
							 <!-- <div class="form-group">
								<label>Password:</label> <input type="password" id="password"
									name="password" class="form-control" data-toggle="password">
							</div>  -->
							<div class="form-group row">
								<label for="security" class="col-sm-4 col-form-label">Create
									Password</label>
								<div class="col-sm-6">
									<input type="password"  class="form-control" id="security" >
								</div>
							</div>
							<div class="form-group row">
